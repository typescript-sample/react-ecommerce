                ...
                <div className='dropdown-menu-profile'>
                  ...
                  {user &&
                    <ul id='dropdown-basic' className={state.showProfile + ' dropdown-content-profile'}>
                      ...
                      <li><i className='material-icons'>list_alt</i><Link to={'my-item'}>My Items</Link></li>
                      <li><i className='material-icons'>location_on</i><Link to={'my-location'}>My Locations</Link></li>
                      <hr style={{ margin: 0 }} />
                      <li>
