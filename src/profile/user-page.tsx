...
export function UserPage() {
  ...
  const handleReact = async () => {
    const rep = await reactService.react(id, userId, react)
    console.log(rep)
  }
    ...
    <div className='profile view-container'>
      <form id='userForm' name='userForm' ref={refForm as any}>
        ...
        <div className='row'>
          ...
          <Review i={user} get={getUser} id={id} userId={userId} rateRange={5} rateService={rateService} reactionService={reactionService} commentService={commentService} />
        </div>
        {/* <Appreciations /> */}
