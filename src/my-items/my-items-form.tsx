...
import { OnClick, Search, SearchComponentState, useSearch, value, checked } from "react-hook-core";
                    ...
                    <li key={i} className="col s12 m6 l4 xl3">
                      <section>
                        <div>
                          <h3>{item.title}</h3>
                          <img
                            src={item.gallery && item.gallery[0].url ? item.gallery[0].url : noPhoto}
                            width={100}
                            alt=""
                          />
                        ...
                        <button className="btn-detail" onClick={(e: any) => edit(e, item.id)} />
                      </section>
                    </li>
                  );
                })}
