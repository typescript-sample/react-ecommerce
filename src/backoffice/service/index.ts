...
import { ShopService } from './location/location';
...
class ApplicationContext {
  ...
  getLocationService(): ShopService {
    if (!this.shopService) {
      const c = this.getConfig();
      this.shopService = new LocationClient(httpRequest, c.location_url);
    }
...
export function getShops(): ShopService {
